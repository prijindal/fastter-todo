...
import 'package:fastter_todo/pages/todo/index.dart' as _i18;
import 'package:fastter_todo/pages/todochildren/index.dart' as _i15;
import 'package:fastter_todo/pages/todocomments/index.dart' as _i16;
import 'package:fastter_todo/pages/todoreminders/index.dart' as _i17;
import 'package:fastter_todo/pages/todos/index.dart' as _i19;
import 'package:flutter/material.dart' as _i21;

/// generated route for
/// [_i1.BackendSettingsScreen]
class BackendSettingsRoute extends _i20.PageRouteInfo<void> {
  const BackendSettingsRoute({List<_i20.PageRouteInfo>? children})
...
class BackupSettingsRoute extends _i20.PageRouteInfo<void> {
  const BackupSettingsRoute({List<_i20.PageRouteInfo>? children})
...
class EditProjectRoute extends _i20.PageRouteInfo<EditProjectRouteArgs> {
  EditProjectRoute({
    _i21.Key? key,
...
class FirebaseBackupRoute extends _i20.PageRouteInfo<void> {
  const FirebaseBackupRoute({List<_i20.PageRouteInfo>? children})
...
class FirebaseLoginRoute extends _i20.PageRouteInfo<void> {
  const FirebaseLoginRoute({List<_i20.PageRouteInfo>? children})
...
class FirebaseProfileRoute extends _i20.PageRouteInfo<void> {
  const FirebaseProfileRoute({List<_i20.PageRouteInfo>? children})
...
class HelpSettingsRoute extends _i20.PageRouteInfo<void> {
  const HelpSettingsRoute({List<_i20.PageRouteInfo>? children})
...
class NewProjectRoute extends _i20.PageRouteInfo<void> {
  const NewProjectRoute({List<_i20.PageRouteInfo>? children})
...
class NotificationsSettingsRoute extends _i20.PageRouteInfo<void> {
  const NotificationsSettingsRoute({List<_i20.PageRouteInfo>? children})
...
class PermissionsSettingsRoute extends _i20.PageRouteInfo<void> {
  const PermissionsSettingsRoute({List<_i20.PageRouteInfo>? children})
...
/// generated route for
/// [_i11.ProjectsScreen]
class ProjectsRoute extends _i20.PageRouteInfo<void> {
  const ProjectsRoute({List<_i20.PageRouteInfo>? children})
...
class SecuritySettingsRoute extends _i20.PageRouteInfo<void> {
  const SecuritySettingsRoute({List<_i20.PageRouteInfo>? children})
...
class StylingSettingsRoute extends _i20.PageRouteInfo<void> {
  const StylingSettingsRoute({List<_i20.PageRouteInfo>? children})
...
/// generated route for
/// [_i15.TodoChildrenScreen]
class TodoChildrenRoute extends _i20.PageRouteInfo<TodoChildrenRouteArgs> {
  TodoChildrenRoute({
    _i21.Key? key,
  ...
  static _i20.PageInfo page = _i20.PageInfo(
    ...
    builder: (data) {
      ...
      return _i15.TodoChildrenScreen(key: args.key, todoId: args.todoId);
    },
  );
}
...
/// generated route for
/// [_i16.TodoCommentsScreen]
class TodoCommentsRoute extends _i20.PageRouteInfo<TodoCommentsRouteArgs> {
  TodoCommentsRoute({
    _i21.Key? key,
    required String todoId,
    List<_i20.PageRouteInfo>? children,
  ...
  static _i20.PageInfo page = _i20.PageInfo(
    ...
    builder: (data) {
      ...
      return _i16.TodoCommentsScreen(key: args.key, todoId: args.todoId);
    },
  );
}
...
/// generated route for
/// [_i17.TodoRemindersScreen]
class TodoRemindersRoute extends _i20.PageRouteInfo<TodoRemindersRouteArgs> {
  TodoRemindersRoute({
    _i21.Key? key,
    required String todoId,
    List<_i20.PageRouteInfo>? children,
  ...
  static _i20.PageInfo page = _i20.PageInfo(
    ...
    builder: (data) {
      ...
      return _i17.TodoRemindersScreen(key: args.key, todoId: args.todoId);
    },
  );
}
...
/// generated route for
/// [_i18.TodoScreen]
class TodoRoute extends _i20.PageRouteInfo<TodoRouteArgs> {
  TodoRoute({
    _i21.Key? key,
    required String todoId,
    List<_i20.PageRouteInfo>? children,
  ...
  static _i20.PageInfo page = _i20.PageInfo(
    ...
    builder: (data) {
      ...
      return _i18.TodoScreen(key: args.key, todoId: args.todoId);
    },
  );
}
...
/// generated route for
/// [_i19.TodosScreen]
class TodosRoute extends _i20.PageRouteInfo<TodosRouteArgs> {
  TodosRoute({
    _i21.Key? key,
