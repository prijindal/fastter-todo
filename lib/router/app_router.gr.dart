...
import 'package:fastter_todo/pages/settings/help.dart' as _i6;
import 'package:fastter_todo/pages/settings/index.dart' as _i10;
import 'package:fastter_todo/pages/settings/security.dart' as _i9;
import 'package:fastter_todo/pages/settings/styling.dart' as _i11;
import 'package:fastter_todo/pages/todo/index.dart' as _i14;
import 'package:fastter_todo/pages/todocomments/index.dart' as _i12;
import 'package:fastter_todo/pages/todoreminders/index.dart' as _i13;
import 'package:fastter_todo/pages/todos/index.dart' as _i15;
import 'package:flutter/material.dart' as _i17;

/// generated route for
/// [_i1.BackendSettingsScreen]
class BackendSettingsRoute extends _i16.PageRouteInfo<void> {
  const BackendSettingsRoute({List<_i16.PageRouteInfo>? children})
...
class FirebaseBackupRoute extends _i16.PageRouteInfo<void> {
  ...
  static _i16.PageInfo page = _i16.PageInfo(
    name,
    builder: (data) {
      return const _i3.FirebaseBackupScreen();
    },
  );
}

/// generated route for
/// [_i4.FirebaseLoginScreen]
class FirebaseLoginRoute extends _i16.PageRouteInfo<void> {
  ...
  static _i16.PageInfo page = _i16.PageInfo(
    name,
    builder: (data) {
      return const _i4.FirebaseLoginScreen();
    },
  );
}

/// generated route for
/// [_i5.FirebaseProfileScreen]
class FirebaseProfileRoute extends _i16.PageRouteInfo<void> {
  ...
  static _i16.PageInfo page = _i16.PageInfo(
    name,
    builder: (data) {
      return const _i5.FirebaseProfileScreen();
    },
  );
}

/// generated route for
/// [_i6.HelpSettingsScreen]
class HelpSettingsRoute extends _i16.PageRouteInfo<void> {
  ...
  static _i16.PageInfo page = _i16.PageInfo(
    name,
    builder: (data) {
      return const _i6.HelpSettingsScreen();
    },
  );
}
...
class SecuritySettingsRoute extends _i16.PageRouteInfo<void> {
  ...
  static _i16.PageInfo page = _i16.PageInfo(
    name,
    builder: (data) {
      return const _i9.SecuritySettingsScreen();
    },
  );
}
...
class TodoCommentsRoute extends _i16.PageRouteInfo<TodoCommentsRouteArgs> {
  ...
  static _i16.PageInfo page = _i16.PageInfo(
    ...
    builder: (data) {
      ...
      return _i12.TodoCommentsScreen(key: args.key, todoId: args.todoId);
    },
  );
}
...
class TodoRemindersRoute extends _i16.PageRouteInfo<TodoRemindersRouteArgs> {
  ...
  static _i16.PageInfo page = _i16.PageInfo(
    ...
    builder: (data) {
      ...
      return _i13.TodoRemindersScreen(key: args.key, todoId: args.todoId);
    },
  );
}
...
class TodoRoute extends _i16.PageRouteInfo<TodoRouteArgs> {
  ...
  static _i16.PageInfo page = _i16.PageInfo(
    ...
    builder: (data) {
      ...
      return _i14.TodoScreen(key: args.key, todoId: args.todoId);
    },
  );
}
...
/// generated route for
/// [_i15.TodosScreen]
class TodosRoute extends _i16.PageRouteInfo<TodosRouteArgs> {
  TodosRoute({
    _i17.Key? key,
